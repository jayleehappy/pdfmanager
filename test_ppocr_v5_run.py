...
# 直接在当前环境运行，不要子进程（避免unicode escape问题）
...
print("===== PP-OCRv5 完整OCR测试（禁用PIR）=====\n")

print("初始化模型...")
det = create_predictor(
    model_name='PP-OCRv5_server_det',
    model_dir=r'D:\grsxbd\paddle\models\PP-OCRv5_server_det',
    pp_option=pp_option
)
rec = create_predictor(
    model_name='PP-OCRv5_server_rec',
    model_dir=r'D:\grsxbd\paddle\models\PP-OCRv5_server_rec',
    pp_option=pp_option
)
print("模型初始化完成")
